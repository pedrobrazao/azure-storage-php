...
class StorageErrorFactory {
    ...
    static getInvalidPageRange2(contextID, contentRange) {
        let returnValue = new StorageError_1.default(416, "InvalidRange", "The range specified is invalid for the current size of the resource.", contextID);
        if (contentRange) {
    ...
    static getBothUserTagsAndSourceTagsCopyPresentException(contextID) {
        return new StorageError_1.default(400, "BothUserTagsAndSourceTagsCopyPresentException", "x-ms-tags header must not be present with x-ms-copy-source-tag-option as COPY.", contextID);
    }
    ...
    static getInvalidResourceName(contextID = "") {
        return new StorageError_1.default(400, "InvalidResourceName", `The specified resource name contains invalid characters.`, contextID);
    }
    ...
    static getInvalidXmlDocument(contextID = "") {
        return new StorageError_1.default(400, "InvalidXmlDocument", `XML specified is not syntactically valid.`, contextID);
    }
}
